...
from visuals.cmn_yunyi_0605.main import CMN, ForegroundStationary, ForegroundMovingForward, ForegroundMovingBackward, BackgroundStationaryBackward, BackgroundStationaryForward, \
...
class CMN_FORE_BACK0605(vxprotocol.StaticProtocol):
    def create(self):
        # CMN
