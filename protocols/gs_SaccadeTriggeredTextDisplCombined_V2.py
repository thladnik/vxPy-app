...
class SaccadeTriggeredTextDisplCombined(vxprotocol.TriggeredProtocol):
    ...
    def __init__(self, *args, **kwargs):
        ...
        conditions = [(-1, 20, 0.5), (-1, 100, 0.5), (-1, 250, 0.5), (-1, 500, 0.5),
                      (-1, 1000, 0.5), (-1, 2000, 0.5), (-1, 4000, 0.5), (-1, 333, 0), (-1, 6500, 0.5),
                      (1, 20, 0.5), (1, 100, 0.5), (1, 250, 0.5), (1, 500, 0.5), (1, 1000, 0.5),
                      (1, 2000, 0.5), (1, 4000, 0.5), (1, 333, 0), (1, 6500, 0.5),
                      (0, 20, 0.5), (0, 100, 0.5), (0, 250, 0.5), (0, 500, 0.5), (0, 1000, 0.5), (0, 2000, 0.5),
                      (0, 4000, 0.5), (0, 6500, 0.5), (0, 6500, 0.5)]
                      # changes: removed (0, 333, 0), added (-1, 6500, 0.5), (1, 6500, 0.5)
        ...
        p = vxprotocol.Phase(duration=16)
