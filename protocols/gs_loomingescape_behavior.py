...
class LoomingEscapeBehavior(StaticProtocol):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for stim_type in np.random.permutation(variants):
            ...
            if stim_type == 1:
                p = Phase(duration=8)
                p.set_visual(SimuSaccadeWithSineFlash2000, saccade2000(sacc_duration, sacc_start, sacc_ang, sine_start, sine_dur,
                                         sine_amp, sine_freq, baseline_lum, contrast))
                self.add_phase(p)
