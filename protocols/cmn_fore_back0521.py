...
from visuals.cmn_yunyi_0521.main import CMN, ForegroundStationary, ForegroundMovingForward, ForegroundMovingBackward, BackgroundStationaryBackward, BackgroundStationaryForward, \
    BackgroundStationaryBackwardReverse, ForegroundMovingBackwardReverse, ForegroundMovingForwardReverse, ForegroundStationaryReverse, CMNReverse, Pause2, Pause3, Pause4, Pause5, Pause6, Pause7, Pause8, Pause9, Pause_middel, BackgroundStationaryForwardReverse


class CMN_FORE_BACK0515(vxprotocol.StaticProtocol):
    def create(self):
        # CMN
        ...
        # Pause
        phase = vxprotocol.Phase(duration=1 * 5)
        phase.set_visual(Pause_middel)
        self.add_phase(phase)

        # CMN
        phase = vxprotocol.Phase(duration=3 * 5)
        phase.set_visual(BackgroundStationaryForwardReverse)
        self.add_phase(phase)
