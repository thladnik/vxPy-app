...
class Pause2(CMN_FORE_BACK):
    ...
    initiation = 1
    back_and_forth_num = 1
    past_time_position = math.pi * 15 / 6
...
class Pause5(CMN_FORE_BACK):
    ...
    initiation = 1
    back_and_forth_num = 1
    past_time_position = -15 * math.pi / 6
...
class Pause_middel(CMN_FORE_BACK):
    VERT_PATH = 'pause_middel.vert'
    FRAG_PATH = 'pause_middel.frag'
    phase_num: int = 2
    pause_num: int = 3
    duration: int = 0
    CMN_phase: int = 0
...
class BackgroundStationaryForwardReverse(CMN_FORE_BACK):
    VERT_PATH = 'background_stationary_foreward_reverse.vert'
    FRAG_PATH = 'background_stationary_foreward_reverse.frag'
    phase_num: int = 2
    pause_num: int = 3
    duration: int = 15
    CMN_phase: int = 1
