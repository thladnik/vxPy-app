...
class CMN_FORE_BACK(vxvisual.SphericalVisual):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for i in range(self.phase_num * self.duration * self.fps):
    ...
    def initialize(self, **kwargs):
        self.time.data = self.phase_num * self.duration
        self.frame_index.data = self.phase_num * self.duration * self.fps - 1
