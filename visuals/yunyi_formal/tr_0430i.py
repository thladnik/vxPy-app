...
class Triangle(vxvisual.SphericalVisual):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.sphere = sphere.Yunyi0430Sphere(azim_lvls=60, elev_lvls=30, upper_elev=np.pi / 2, subdivisionTimes=2)
        ...
        vxcontainer.dump(
            dict(motion_matrix=self.motion_matrix, rotated_motion_matrix=self.rotated_motion_matrix,
                 positions=self.sphere.a_position, texture_coords=self.texture_coords,
