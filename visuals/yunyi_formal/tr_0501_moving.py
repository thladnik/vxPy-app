...
class Triangle(vxvisual.SphericalVisual):
    ...
    # Paths to shaders
    VERT_PATH = 'position_fore_back_fore.vert'
    FRAG_PATH = 'texture_fore_back_fore.frag'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.sphere = sphere.Yunyi0430Sphere(azim_lvls=32, elev_lvls=30, upper_elev=np.pi / 2, subdivisionTimes=2)
